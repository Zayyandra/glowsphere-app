...
export default function AddTestimoni() {
  return (
    <div className="p-6">
      <PageHeader />
      <h1 className="text-2xl font-bold text-gray-800 mb-6">➕ Tambah Testimoni Baru</h1>

      {/* Grid tipis di form container */}
      <div className="bg-white shadow-lg rounded-xl p-6 max-w-xl border border-gray-200">
        <form className="space-y-5">
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700">Testimoni ID</label>
            <input
